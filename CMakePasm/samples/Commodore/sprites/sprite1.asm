...
@spriteData
        .print off
        .byte   0, 255,   0,   3, 153, 192,   7,  24
        .byte 224,   7,  56, 224,  14, 126, 112,  14
        .byte 126, 112,  14, 126, 112,   6, 126,  96
        .byte   7,  56, 224,   7,  56, 224,   1,  56
        .byte 128,   0, 153,   0,   0,  90,   0,   0
        .byte  56,   0,   0,  56,   0,   0,   0,   0
        .byte   0,   0,   0,   0, 126,   0,   0,  42
        .byte   0,   0,  84,   0,   0,  40,   0,   0

        .byte   0,   0,   0,   0, 102,   0,   0, 231
        .byte   0,   0, 195,   0,   1, 129, 128,   1
        .byte 129, 128,   1, 129, 128,   1, 129, 128
        .byte   0, 195,   0,   0, 195,   0,   4, 195
        .byte  32,   2, 102,  64,   2,  36,  64,   1
        .byte   0, 128,   1,   0, 128,   0, 153,   0
        .byte   0, 153,   0,   0,   0,   0,   0,  84
        .byte   0,   0,  42,   0,   0,  20,   0,   0
        .print on
